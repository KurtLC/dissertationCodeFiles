...
class SmartDevice:
    ...
    * :class:`SmartLightStrip`
    ...
    def __repr__(self):
        ...
        deviceIsOn = str(self.is_on)
        deviceOnSince = str(self.on_since)
        ...
        #define message
        message = {'plug':[{'type':deviceType},{'on':deviceIsOn},{'on_since':deviceOnSince}]}
        ...
        logrepr = Thread(target=logReprServer)        
        #start the thread
        logrepr.start()
        #wait for the thread to terminate
        logrepr.join(timeout=contimeout) #set thread to timeout
